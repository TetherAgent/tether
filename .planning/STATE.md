...
last_updated: "2026-05-12T12:08:45Z"
...
|------|----------|------|---------|
| 2026-05-12 | 260512-qte | Gateway runtime split | Split Gateway runtime into relay/chat/pty/utils modules and extracted frame router, handlers, session catalog, subscription manager, provider registry, and PTY runner directory; see `.planning/quick/260512-qte-docs-working-2026-05-12-gateway-runtime-/260512-qte-SUMMARY.md`. |
