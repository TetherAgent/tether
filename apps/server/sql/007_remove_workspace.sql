...
ALTER TABLE users ADD INDEX idx_users_account_id (account_id);
...
ALTER TABLE admin_users ADD INDEX idx_admin_users_account_id (account_id);
...
ALTER TABLE devices ADD INDEX idx_devices_account_id (account_id);
...
ALTER TABLE gateways ADD INDEX idx_gateways_account_id (account_id);
...
ALTER TABLE refresh_tokens ADD INDEX idx_refresh_tokens_account_id (account_id);
...
ALTER TABLE gateway_refresh_tokens ADD INDEX idx_gateway_refresh_tokens_account_id (account_id);
...
ALTER TABLE audit_events ADD INDEX idx_audit_events_account_id (account_id);
...
ALTER TABLE gateway_sessions ADD INDEX idx_gateway_sessions_account_id (account_id);
